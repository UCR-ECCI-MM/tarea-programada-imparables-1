...
_lr_action_items = {'LBRACKET':([0,3,4,7,8,9,10,11,12,13,19,33,36,39,43,61,68,81,],[5,5,-7,-4,-6,-9,-10,-11,-12,-13,-8,-14,-25,-29,-39,73,79,-5,]),'$end':([1,2,3,4,6,7,8,9,10,11,12,13,19,33,36,39,43,81,],[0,-1,-3,-7,-2,-4,-6,-9,-10,-11,-12,-13,-8,-14,-25,-29,-39,-5,]),'BEGIN_DIAGNOSTIC':([4,9,10,11,12,13,33,36,39,43,81,],[14,14,-10,-11,-12,-13,-14,-25,-29,-39,-5,]),'BEGIN_BOOT_SEQUENCE':([4,9,10,11,12,13,33,36,39,43,81,],[15,15,-10,-11,-12,-13,-14,-25,-29,-39,-5,]),'BEGIN_CRASH_REPORT':([4,9,10,11,12,13,33,36,39,43,81,],[16,16,-10,-11,-12,-13,-14,-25,-29,-39,-5,]),'BEGIN_BACKUP':([4,9,10,11,12,13,33,36,39,43,81,],[17,17,-10,-11,-12,-13,-14,-25,-29,-39,-5,]),'DATE':([5,],[18,]),'CHECK':([14,21,126,],[22,22,-17,]),'STEP':([15,24,60,],[25,25,-28,]),'IDENTIFIER':([16,27,63,],[28,41,-31,]),'SOURCE':([17,],[31,]),'TIME':([18,],[32,]),'END_DIAGNOSTIC':([20,21,34,126,],[33,-16,-15,-17,]),'STRING':([22,38,46,52,56,72,79,92,105,106,110,111,],[35,49,57,62,69,82,94,103,94,116,119,120,]),'END_BOOT_SEQUENCE':([23,24,37,60,],[36,-27,-26,-28,]),'COLON':([25,28,31,41,45,51,55,78,91,99,101,118,],[38,42,46,52,56,61,68,92,102,110,111,124,]),'END_CRASH_REPORT':([26,50,107,],[39,-30,-33,]),'END_BACKUP':([29,54,64,65,66,75,89,114,],[43,-47,-40,-46,-49,-48,-50,-43,]),'DESTINATION':([30,70,],[45,-41,]),'RBRACKET':([32,86,87,93,94,108,115,123,],[47,96,-35,104,-45,-34,-44,-36,]),'ARROW':([35,],[48,]),'STACK_TRACE':([40,74,],[51,-32,]),'NUMBER':([42,102,124,],[53,112,127,]),'FILE_LIST':([44,80,],[55,-42,]),'LOGLEVEL':([47,],[58,]),'LBRACE':([48,73,97,],[59,88,88,]),'SEMICOLON':([49,53,57,62,69,96,103,104,112,120,122,],[60,63,70,74,80,107,113,114,121,125,126,]),'BEGIN_BACKUP_UPDATE':([54,66,89,114,],[67,67,-50,-43,]),'ENTRY_NUMBER':([58,],[71,]),'RESULT':([59,],[72,]),'TIMESTAMP':([67,],[78,]),'ENTRY_MESSAGE':([71,],[81,]),'PASS':([72,],[84,]),'FAIL':([72,],[85,]),'END_BACKUP_UPDATE':([76,100,125,],[89,-51,-54,]),'PROGRESS':([77,113,],[91,-52,]),'COMMA':([82,83,84,85,87,94,98,119,123,],[-24,95,-22,-23,97,105,109,-37,-36,]),'FUNCTION':([88,],[99,]),'DETAILS':([90,121,],[101,-53,]),'LATENCY':([95,],[106,]),'LINE':([109,],[118,]),'RBRACE':([116,117,127,],[122,123,-38,]),}
...
_lr_productions = [
  ...
  ('step_line -> STEP COLON STRING SEMICOLON','step_line',4,'p_step_line','parser.py',111),
